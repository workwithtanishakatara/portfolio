          ...
          <AnimatePresence mode="popLayout">
            {hoveredIndex === item._id && (
              <motion.div
                ...
                className="absolute -top-16  translate-x-1/2 -left-[200%] md:-left-[50%] flex text-xs  flex-col items-center justify-center rounded-md bg-black z-50 shadow-xl px-4 py-2"
              >
